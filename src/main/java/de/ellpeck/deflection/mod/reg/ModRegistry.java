package de.ellpeck.deflection.mod.reg;

import de.ellpeck.deflection.mod.Deflection;
import de.ellpeck.deflection.mod.reg.IModelProvider.ModelVariant;
import de.ellpeck.deflection.mod.util.CreativeTab;
        ...
        for(IModItem item : ALL_ITEMS){
            ...
            if(item instanceof IModelProvider){
                ...
                for(ItemStack stack : models.keySet()){
                    ...
                    Deflection.proxy.registerRenderer(stack, variant.location, variant.variant);
                }
            }
